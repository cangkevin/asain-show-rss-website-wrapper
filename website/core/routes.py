...
def movies(category, page):
    ...
    return dict(current_category=category, response=client.get_movies(category, page))
...
def shows(category, page):
    ...
    return dict(current_category=category, response=client.get_shows(category, page))
...
def episodes(show_id, page):
    ...
    return dict(current_show=show_id, response=client.get_episodes(show_id, page))
